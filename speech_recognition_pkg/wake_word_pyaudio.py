...
class WakeWord():
    ...
    def __init__(self):
        rospy.init_node('wake_word_listener')
        self.wake_word_pub = rospy.Publisher('/wake_word', Bool, queue_size=10)
        self.wake_word_sub = rospy.Subscriber('/wake_word', Bool, self.on_wake)

    def on_wake(self, msg):
        

    def set_wake_word(self, active):
        rospy.loginfo("WAKE WORD: " + str(active))
        self.wake_word_pub.publish(active)
        ...
        try:
            ...
            while True:
                ...
                if num_keywords == 1 and result:
                    ...
                    self.ros_wake_word.set_wake_word(True)
